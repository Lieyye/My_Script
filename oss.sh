...
AnyKernel="https://github.com/rsuntk/AnyKernel3.git"
...
# clang config
REMOTE="https://github.com/Neutron-Toolchains"
TARGET="clang-build-catalogue"
REPO="https://github.com/Neutron-Toolchains/clang-build-catalogue.git"
BRANCH="main"
